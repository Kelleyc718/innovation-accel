...
//The render Function
var render = function() {
  // console.log("The Obj Scene is: ", ourObj);
...
loader.load(
  ...
  function(gltf) {
    ...
    ourObj = gltf.scene;
    ourObj.position.x = 0.9;
    ourObj.position.y = -0.8;
    ourObj.position.z = 0.5;
    //
    // ourObj.children[2].position.x = 0.6;
    // ourObj.children[2].position.y = 0.3;
    // ourObj.children[2].position.z = 1.01;

    ourObj.rotation.y = 4.70089;
    ourObj.rotation.z = -0.1;

    // ourObj.children[2].rotation.y = 4.70089;
    // ourObj.children[2].rotation.z = -0.2;
